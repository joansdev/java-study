...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 인터페이스 활용 "익명클래스" 만들기 - 클래스(파일) 따로 생성 없이, 인터페이스로부터 1회성 구현
        ...
        // 인터페이스 활용 람다식(익명클래스를 간단하게 표현식) 만들기
        ...
        Calculator cal2 = (a, b) -> a + b; // 람다 구현체 자체를 cal2 변수에 넣어줌
        int ret4 = calculate(5, 6, cal2);
